...
W_OURS = {
    ...
    'ships':           +0.180,
    'n_cross':         -1.146,
    'late_aggression':  +0.029,   # для своих планет смысла не несёт
}
W_TARGETS = {
    'area_inv':        +0.088,
    'wnn_close_res':   +0.634,    # tournament-winner (turn 2026-04-28): был +0.8
    'mean_dist_all':   +0.152,    # tournament-winner (turn 2026-04-28): был -0.6
    'prod':            -0.300,
    'ships':            -0.555,    # tournament-winner (turn 2026-04-28): был -0.7
    'n_cross':         +1.403,
    'late_aggression': +0.473,   # БАЗОВЫЙ вес (phase-multiplier применяется внутри
